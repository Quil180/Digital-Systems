...
HD_PWD='/home/yousef/Desktop/UCF/Classes/Spring25/EEE3342C/Labs/experiment-3/part-1/part-1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log part_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source part_1.tcl
