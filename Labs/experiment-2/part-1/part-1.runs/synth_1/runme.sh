...
HD_PWD='/home/yousef/Desktop/UCF/Classes/Spring25/EEE3342C/Labs/experiment-2/part-1/part-1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CIRCUIT_DEBUGGING.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CIRCUIT_DEBUGGING.tcl
