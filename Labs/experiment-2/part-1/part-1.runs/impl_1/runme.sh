...
HD_PWD='/home/yousef/Desktop/UCF/Classes/Spring25/EEE3342C/Labs/experiment-2/part-1/part-1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CIRCUIT_DEBUGGING.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CIRCUIT_DEBUGGING.tcl -notrace
