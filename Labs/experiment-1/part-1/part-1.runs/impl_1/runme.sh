...
HD_PWD='/home/yousef/Desktop/UCF/Classes/Spring25/EEE3342C/Labs/experiment-1/part-1/part-1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AND.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AND.tcl -notrace
